...
public class MenuDrivenPractice 
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            switch (choice)
            {
                case 1: System.out.print("Enter inches: ");
                    inches = console.nextInt();
                    System.out.println();
                    System.out.printf("%d inces(es) = %d centimeter(s) %n", inches, inchesToCentimeters(inches));
                    break;

                case 2: System.out.print("Enter centimeters: ");
                    centimeters = console.nextInt();
                    System.out.println();
                    System.out.printf("%d centimeter(s) = %d inch(es) %n", centimeters, centToInches(centimeters));
                    break;
    ...
    public static void showChoices()
    {
        ...
        System.out.println("2: To convert from centimeters to inces");
